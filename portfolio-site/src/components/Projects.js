...
<div>
    <div className='project-container'>
        ...
        <div className='project-box'>
            <h3>Quotable - Fullstack 
                <a href="https://github.com/Paul-Austin-Oswego-CSC480-HCI521/OZ-CSC-480-HCI-521-Spring-2025" target="_blank" rel="noopener noreferrer" className='github-icon'><FaGithub size={20} /></a>
            </h3>
        ...
        <div className='project-box'>
            <h3>Envisionary Application - Fullstack 
                <a href="https://github.com/Sakshyam103/EnvisionaryApp" target="_blank" rel="noopener noreferrer" className='github-icon'><FaGithub size={20} /></a>
            </h3>
             <div className='text-container'>
        ...
        <div className='project-box'>
            <h3>AWS Deployment - Server and Agent 
                <a href="https://github.com/kparajul/server-kparajul" target="_blank" rel="noopener noreferrer" className='github-icon'><FaGithub size={20} /></a>
            </h3>
             <div className='text-container'>
        ...
        <div className='project-box'>
            <h3>Genetic Algorithm Implementation - Parallelism 
                <a href="https://github.com/kparajul/Genetic-Algorithm-Program" target="_blank" rel="noopener noreferrer" className='github-icon'><FaGithub size={20} /></a>
            </h3>
             <div className='text-container'>
        ...
        <div className='project-box'>
            <h3>Proxy Server Implementation - TCP, UDP, TFTP 
                <a href="https://github.com/kparajul/ProxyServerImplementation" target="_blank" rel="noopener noreferrer" className='github-icon'><FaGithub size={20} /></a>
            </h3>
             <div className='text-container'>
